...
public class MissleBulletCreationPointScript : MonoBehaviour
{
    //Declaration
    ...
    void Start()
    {
        ...
        TTS2 = GetComponentInParent<TurretTargeting2Script>();
    }
    ...
    {
        if (TTS2.enemyDetectedAnswer == true && dontFireTime <= 0)
        {
